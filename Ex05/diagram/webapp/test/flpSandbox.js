		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 Exercise 05",
									"targetURL": "#UX410Exercise05-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"UX410Exercise05-display": {
								"semanticObject": "UX410Exercise05",
								"action": "display",
								"description": "Diagram",
								"title": "UX410 Exercise 05",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student00.sap.training.diagram",
									"url": sap.ui.require.toUrl("student00/sap/training/diagram")
								}
							}
						}
					}
