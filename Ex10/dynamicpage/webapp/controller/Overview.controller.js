sap.ui.define(
  ...
  function (Controller, Filter, FilterOperator, Sorter) {
    ...
    return Controller.extend(
      "student00.sap.training.ex10_dynamicpage.controller.App",
      {
        onInit: function () {
        ...
        onSearch: function (oEvent) {
          ...
          if (oEvent.getParameter("query")) {
            ...
            this.aKeys = ["Carrid", "Carrname"];
            aCurrentFilterValues.push(sQuery); //one for Carrid
            aCurrentFilterValues.push(sQuery); //one for Carrname
        ...
        onClear: function (oEvent) {
          ...
          for (var i = 0; i < oItems.length; i++) {
            var oControl = this.oFilterBar.determineControleByFilterItem(
              oItems[i]
            );
            if (oControl) {
              oControl.setValue("");
        ...
        onOpenViewSettings: function (oEvent) {
          if (!this._oViewSettingsDialog) {
            this._oViewSettingsDialog = sap.ui.xmlfragment(
              "student00.sap.training.ex10_dynamicpage.fragments.ViewSettingsDialog",
              this
            );
