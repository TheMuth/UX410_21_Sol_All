sap.ui.define(
  ...
  function (Controller, Filter, FilterOperator) {
    ...
    return Controller.extend(
      "student00.sap.training.ex9_valuehelp.controller.Main",
      {
        _oFormFragments: {},
        ...
        onValueHelpRequest: function (oEvent) {
          ...
          if (!this._oValueHelpDialog) {
            this._oValueHelpDialog = sap.ui.xmlfragment(
              "student00.sap.training.ex9_valuehelp.fragments.CarrierSelectionDialog",
              this
            );
        ...
        _createFlightsTable: function(){
            ...
            oFragment = sap.ui.xmlfragment(this.getView().getId(), "student00.sap.training.ex9_valuehelp.fragments.Flights");
