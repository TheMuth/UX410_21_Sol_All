sap.ui.define([
	...
	function (Controller) {
		...
		return Controller.extend("student00.sap.training.ex12_dynamicpage.controller.Carrier", {
            metadata: {
                methods: {
                    onShowCarrierData: {
                        public: true,
            ...
            onShowCarrierData: function(){
                alert("You are currently viewing the data for carrier " + this.getView().getBindingContext().getProperty("Carrname"));
            },
