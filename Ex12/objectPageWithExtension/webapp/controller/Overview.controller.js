sap.ui.define([
	...
	function (Controller, Filter, FilterOperator, Sorter) {
		...
		return Controller.extend("student00.sap.training.ex12_dynamicpage.controller.Overview", {
            onInit: function() {
            ...
            onOpenViewSettings: function(oEvent) {
			    if (!this._oViewSettingsDialog) {
				    this._oViewSettingsDialog = sap.ui.xmlfragment(
                        "student00.sap.training.ex12_dynamicpage.fragments.ViewSettingsDialog", 
                        this
                    );
